...
type ScheduleRequest struct {
	...
	Distance []float64 `protobuf:"fixed64,4,rep,packed,name=distance,proto3" json:"distance,omitempty"`
}
...
func (x *ScheduleRequest) GetDistance() []float64 {
	if x != nil {
		return x.Distance
	}
	return nil
...
var file_interface_proto_rawDesc = []byte{
	...
	0x61, 0x6e, 0x63, 0x65, 0x18, 0x04, 0x20, 0x03, 0x28, 0x01, 0x52, 0x08, 0x64, 0x69, 0x73, 0x74,
